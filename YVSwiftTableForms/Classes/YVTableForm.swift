...
public class YVTableForm: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    // Mark: - iVar or Properties
    
    public var tblForm: UITableView? {
        didSet {
            ...
            if let strBundlePath = NSBundle(forClass: YVTableForm.classForCoder()).pathForResource("YVSwiftTableForms", ofType: "bundle") {
                
                let bundle = NSBundle(path: strBundlePath)
                
                tblForm?.registerNib(UINib.init(nibName: "YV"+YVRowType.TextOnlyInput.rawValue+"Cell", bundle: bundle), forCellReuseIdentifier: YVRowType.TextOnlyInput.rawValue)
                tblForm?.registerNib(UINib.init(nibName: "YV"+YVRowType.LabelTextInput.rawValue+"Cell", bundle: bundle), forCellReuseIdentifier: YVRowType.LabelTextInput.rawValue)
                tblForm?.registerNib(UINib.init(nibName: "YV"+YVRowType.Button.rawValue+"Cell", bundle: bundle), forCellReuseIdentifier: YVRowType.Button.rawValue)
                tblForm?.registerNib(UINib.init(nibName: "YV"+YVRowType.Label.rawValue+"Cell", bundle: bundle), forCellReuseIdentifier: YVRowType.Label.rawValue)
            }
    ...
    public var arrSections: [YVTableSection?] = []
    public var arrRows: [[YVTableRow?]?] = [[]]
    ...
    public func appendSection(section: YVTableSection?) {
    ...
    public func updateSection(section: YVTableSection?, atIndex: Int) {
    ...
    public func appendRow(row: YVTableRow, toSection: Int = 0) {
